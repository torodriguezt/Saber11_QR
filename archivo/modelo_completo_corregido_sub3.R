...
init_fn <- function() {
  list(
    ...
    alpha = c(261.56, 311.38, 348.40, 285.96, 267.72, 242.34, 293.59, 
              250.44, 228.90, 279.81, 274.02, 298.64, 372.58, 334.52),
    
    # Inicialización de los parámetros mu con sus medias posteriores
    mu = c(293.14, 281.08, 275.71, 300.10),
    ...
    horas_cen = c(4.58, -4.58),
    estrato_cen = c(5.05, 2.95, 1.97, -2.31, -3.02, -4.63),
    internet_cen = c(-4.23, 4.23),
    educ_madre_cen = c(-20.44, -11.60, -3.33, 4.99, 10.64, 19.74),
    educ_padre_cen = c(-18.41, -6.96, -3.85, 4.81, 5.48, 18.91),
    naturaleza_cen = c(-14.12, 14.12)
  )
}
...
print(fit)
save(fit, file = "johnatan3/particion_modelo_completo_sub3.RData")