...
init_fn <- function() {
  list(
    ...
    alpha = c(199.09, 248.92, 282.08, 222.02, 207.45, 189.95, 228.16, 
              193.29, 179.89, 211.50, 205.15, 236.05, 321.89, 275.83),
    
    # Inicialización de los parámetros mu con sus medias posteriores
    mu = c(231.94, 222.19, 217.96, 239.72),
    ...
    educ_madre_cen = c(-14.82, -9.73, -3.73, 6.59, 9.81, 22.00),
    educ_padre_cen = c(-15.12, -8.76, -3.26, 5.73, 5.72, 15.69),
    naturaleza_cen = c(-17.05, 17.05)
  )
}
...
print(fit)
save(fit, file = "johnatan3/particion03_modelo_completo_sub2.RData")