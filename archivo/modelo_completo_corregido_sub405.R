...
init_fn <- function() {
  list(
    ...
    alpha = c(220.79, 271.26, 311.42, 245.03, 231.46, 204.86, 252.74, 
              210.52, 194.05, 241.50, 224.83, 262.26, 337.08, 300.05),
    
    # Inicialización de los parámetros mu con sus medias posteriores
    mu = c(253.45, 243.31, 238.97, 259.91),
    ...
    horas_cen = c(5.16, -5.16),
    estrato_cen = c(9.31, 6.36, 4.77, 0.25, -10.58, -10.11),
    internet_cen = c(-2.91, 2.91),
    educ_madre_cen = c(-10.04, -7.68, -4.20, 4.45, 6.96, 10.52),
    educ_padre_cen = c(-18.89, -10.11, -4.64, 3.14, 5.86, 24.65),
    naturaleza_cen = c(-12.10, 12.10),
...
print(fit)
save(fit, file = "johnatan3/particion05_modelo_completo_sub4.RData")