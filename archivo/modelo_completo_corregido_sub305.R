...
init_fn <- function() {
  list(
    ...
    alpha = c(222.09, 273.02, 312.32, 245.46, 226.53, 205.23, 248.07, 
              213.18, 198.31, 238.22, 227.58, 258.41, 341.23, 302.59),
    
    # Inicialización de los parámetros mu con sus medias posteriores
    mu = c(254.98, 241.75, 238.20, 262.48),
    ...
    horas_cen = c(5.03, -5.03),
    estrato_cen = c(6.13, 4.36, 3.65, -2.25, -6.77, -5.13),
    internet_cen = c(-3.58, 3.58),
    educ_madre_cen = c(-15.85, -10.31, -5.02, 4.90, 10.24, 16.04),
    educ_padre_cen = c(-14.44, -6.31, -4.93, 4.41, 3.03, 18.24),
    naturaleza_cen = c(-14.89, 14.89)
  )
}
...
print(fit)
save(fit, file = "johnatan3/particion05_modelo_completo_sub3.RData")