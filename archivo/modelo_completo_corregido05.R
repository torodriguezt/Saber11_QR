...
init_fn <- function() {
  list(
    ...
    alpha = c(220.19, 272.42, 308.35, 245.68, 228.61, 204.49, 253.17, 
              216.18, 188.09, 238.60, 224.97, 258.71, 345.19, 300.63),
    
    # Inicialización de los parámetros mu con sus medias posteriores
    mu = c(253.81, 243.70, 239.52, 260.54),
    ...
    horas_cen = c(4.25, -4.25),
    estrato_cen = c(7.86, 6.75, 2.99, -1.05, -2.47, -14.07),
    internet_cen = c(-3.77, 3.77),
    educ_madre_cen = c(-17.09, -10.91, -6.53, 3.95, 4.57, 26.00),
    educ_padre_cen = c(-14.73, -8.41, -3.16, 5.55, 6.33, 14.43),
    naturaleza_cen = c(-12.23, 12.23),
...
print(fit)
save(fit, file = "johnatan3/particion05_modelo_completo_sub1.RData")