...
init_fn <- function() {
  list(
    ...
    alpha = c(260.98, 311.17, 344.69, 286.02, 265.19, 236.57, 293.52, 
              246.55, 227.05, 282.86, 264.80, 299.42, 368.38, 337.08),
    
    # Inicialización de los parámetros mu con sus medias posteriores
    mu = c(291.25, 280.30, 276.73, 296.51),
    ...
    horas_cen = c(5.34, -5.34),
    estrato_cen = c(6.66, 5.35, 3.92, -3.67, -3.21, -9.04),
    internet_cen = c(-4.07, 4.07),
    educ_madre_cen = c(-9.85, -12.86, -4.92, 5.39, 6.94, 15.29),
    educ_padre_cen = c(-16.59, -8.80, -4.39, 4.15, 6.41, 19.22),
    naturaleza_cen = c(-7.03, 7.03)
  )
}
...
print(fit)
save(fit, file = "johnatan3/particion_modelo_completo_sub4.RData")