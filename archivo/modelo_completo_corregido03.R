...
init_fn <- function() {
  list(
    ...
    alpha = c(199.58, 248.59, 284.06, 222.72, 208.35, 185.93, 229.63, 
              198.05, 177.46, 216.31, 205.13, 235.17, 324.19, 278.67),
    
    # Inicialización de los parámetros mu con sus medias posteriores
    mu = c(232.41, 223.46, 220.23, 239.25),
    ...
    horas_cen = c(3.97, -3.97),
    estrato_cen = c(6.62, 5.74, 2.21, 0.28, -5.18, -9.67),
    internet_cen = c(-2.62, 2.62),
    educ_madre_cen = c(-12.10, -9.02, -6.68, 4.55, 3.53, 19.72),
    educ_padre_cen = c(-17.83, -8.34, -3.59, 7.66, 4.62, 17.48),
    naturaleza_cen = c(-14.25, 14.25)
  )
}
...
print(fit)
save(fit, file = "johnatan3/particion03_modelo_completo_sub1.RData")